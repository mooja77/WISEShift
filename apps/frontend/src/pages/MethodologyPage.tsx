    ...
    <div className="min-h-screen bg-gradient-to-br from-brand-50 via-white to-indigo-50">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <section className="mt-16">
          <h2 className="text-2xl font-bold text-gray-900">Assessment Framework</h2>
              ...
              <tbody className="divide-y divide-gray-100">
                {DOMAIN_MAPPING.map((row) => (
                  <tr key={row.domain} className="hover:bg-gray-50 transition-colors">
                    <td className="px-5 py-3 text-sm font-medium text-gray-900">{row.domain}</td>
                    <td className="px-5 py-3 text-sm text-gray-600">{row.emes}</td>
                    <td className="px-5 py-3 text-sm text-gray-600">{row.ensie}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <section className="mt-16">
          <h2 className="text-2xl font-bold text-gray-900">Research Foundations</h2>
          <p className="mt-3 max-w-4xl text-gray-600">
        ...
        <section className="mt-16">
          <h2 className="text-2xl font-bold text-gray-900">Maturity Model</h2>
          <p className="mt-3 max-w-4xl text-gray-600">
          ...
          <div className="mt-8 space-y-3">
            {MATURITY_LEVELS.map((level) => (
              ...
              >
                <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full bg-white font-bold shadow-sm">
                  {level.level}
                </div>
                <div>
        ...
        <section className="mt-16">
          <h2 className="text-2xl font-bold text-gray-900">Scoring Approach</h2>
          <p className="mt-3 max-w-4xl text-gray-600">
          ...
          <div className="mt-8 grid gap-6 lg:grid-cols-3">
            <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
              ...
              <h3 className="mt-4 text-lg font-semibold text-gray-900">Quantitative Scoring</h3>
            ...
            <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
              ...
              <h3 className="mt-4 text-lg font-semibold text-gray-900">Qualitative Enrichment</h3>
              <p className="mt-2 text-sm text-gray-600">
            ...
            <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
              ...
              <h3 className="mt-4 text-lg font-semibold text-gray-900">Benchmarks</h3>
              <p className="mt-2 text-sm text-gray-600">
        ...
        <section className="mt-16">
          <h2 className="text-2xl font-bold text-gray-900">EU Policy Alignment</h2>
          <p className="mt-3 max-w-4xl text-gray-600">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            {POLICY_ALIGNMENTS.map((policy) => (
              ...
              >
                ...
                <p className="mt-2 text-sm leading-relaxed text-gray-600">{policy.description}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="mt-16">
          <h2 className="text-2xl font-bold text-gray-900">Links &amp; Resources</h2>
          <p className="mt-3 max-w-4xl text-gray-600">
              ...
              {EXTERNAL_LINKS.map((link) => (
                <li key={link.name}>
                  ...
                  >
                    ...
                    <span className="flex items-center gap-1 text-sm text-brand-600 hover:text-brand-800">
                      Visit
                      <svg
