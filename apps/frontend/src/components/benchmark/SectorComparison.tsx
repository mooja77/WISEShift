            ...
            return (
              ...
              >
                ...
                <td className="whitespace-nowrap px-4 py-3 text-center">
                  <span className="text-sm font-semibold text-brand-700 dark:text-brand-400 tabular-nums">
                    {domain.score.toFixed(1)}
                  </span>
                </td>

                {/* Sector average */}
                <td className="whitespace-nowrap px-4 py-3 text-center text-sm text-gray-600 dark:text-gray-400 tabular-nums">
                  {average.toFixed(1)}
                </td>

                {/* 25th percentile */}
                <td className="whitespace-nowrap px-4 py-3 text-center text-sm text-gray-500 dark:text-gray-400 tabular-nums">
