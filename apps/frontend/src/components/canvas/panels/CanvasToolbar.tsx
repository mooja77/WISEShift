...
export default function CanvasToolbar() {
  ...
  return (
    <>
      <div data-tour="canvas-toolbar" className="flex items-center justify-between border-b border-gray-200/80 bg-white/90 px-4 py-2.5 backdrop-blur-md dark:border-gray-700/80 dark:bg-gray-800/90">
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <button
                    ...
                    className="btn-canvas btn-glow-yellow flex items-center gap-1.5 rounded-lg bg-yellow-50 px-3 py-2 text-xs font-medium text-yellow-700 hover:bg-yellow-100 dark:bg-yellow-900/30 dark:text-yellow-300 dark:hover:bg-yellow-900/50"
                  >
                    <svg className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
